...
<body>
    ...
    <main class="container mt-5 pt-5">
        <h1 class="text-center mb-4">Productos en el Supermercado jenny</h1>
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text"><strong>Categoría:</strong> <?php echo $row['categoria_id'];?></p>
                    <p class="card-text"><strong>Cantidad:</strong> <?php echo $row['cantidad'];?></p>
